...
<div class="col-md-12 grid-margin stretch-card">
    <div class="card">
    <div class="card-body">
        <h4 class="mb-4">List of Categories</h4>
        ...
        <tbody>
            ...
            <td>
                <img
                :src="'/storage/category/' + x.add_banner"
                v-if="x.add_banner"
                style="max-width: 200px; max-height: 50px"
                />
    ...
    <div class="modal-content">
        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                >
                    <span v-if="!app.id">Add Category</span>
                    <span v-if="app.id">Update Category</span>
                </button>
                </div>
            </div>
            </form>
...
saveApp() {
    var k = "Do you want to save this category?";
    if (this.app.id) {
    k = "Do you want to update this category?";
    }
    ...
    if (result.isConfirmed) {
        ...
        axios
        .post("/admin/save-category", this.datax, config)
        .then((response) => {
...
async loadAppSetting(page = 1) {
    this.page = page;
    let res = await axios.get("/admin/get-category", {
