...
<section
    ...
    v-bind:style="{
    backgroundImage: 'url(/storage/guide/' + _kes.banner + ')',
    }"
>
    <div
    ...
    <div class="container">
        ...
        <h1 class="mb-3" :title="_kes.name" v-if="_kes.name.length>17">{{ _kes.name | liveSubstr  }}</h1>
        <h1 class="mb-3" :title="_kes.name" v-if="_kes.name.length<17">{{ _kes.name  }}</h1>
        </div>
    </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="single-content">
            ...
            <div class="description-images mb-4">
                ...
                <img
                :src="'/storage/guide/' + _kes.add_banner"
                alt=""
                class="w-100 rounded"
        ...
        <div class="sidebar-sticky">
            ...
            <div class="sidebar-item mb-4">
                ...
                <li v-for="x in _plan" :key="x.id"><a :href="'/plan/'+x.id">{{x.name}}</a></li>
                </ul>
            </div>
            </div>
        </div>
